...
export type RootQuery = {
  ...
  allCodeSnippet: Array<CodeSnippet>;
...
export type RootQueryCodeSnippetArgs = {
  id: Scalars['ID'];
};
...
export type RootQueryAllCodeSnippetArgs = {
  where?: Maybe<CodeSnippetFilter>;
  sort?: Maybe<Array<CodeSnippetSorting>>;
  limit?: Maybe<Scalars['Int']>;
  offset?: Maybe<Scalars['Int']>;
};
...
export type CodeSnippet = Document & {
...
export type Homepage = Document & {
  ...
  primaryBlockContentRaw?: Maybe<Scalars['JSON']>;
};
...
export type PostFilter = {
  ...
  featuredImage?: Maybe<PictureFilter>;
...
export type PictureFilter = {
  _key?: Maybe<StringFilter>;
  _type?: Maybe<StringFilter>;
  attribution?: Maybe<StringFilter>;
...
export type PostSorting = {
  ...
  featuredImage?: Maybe<PictureSorting>;
...
export type CodeSnippetSorting = {
  _id?: Maybe<SortOrder>;
  _type?: Maybe<SortOrder>;
  _createdAt?: Maybe<SortOrder>;
  _updatedAt?: Maybe<SortOrder>;
...
export type BlockOrCodeSnippetOrPicture = Block | CodeSnippet | Picture;
...
export type GetHomepageQuery = (
  ...
  & { allHomepage: Array<(
    { __typename?: 'Homepage' }
    & Pick<Homepage, 'title' | 'subtitle' | 'primaryBlockContentRaw'>
  )> }
);
...
export type GetPostQuery = (
  ...
  & { allPost: Array<(
    { __typename?: 'Post' }
    & Pick<Post, '_id' | 'title' | 'publishedAt' | 'summary' | 'bodyRaw'>
    & { slug?: Maybe<(
      { __typename?: 'Slug' }
      & Pick<Slug, 'current'>
    )>, author?: Maybe<(
      ...
      { __typename?: 'Picture' }
      & Pick<Picture, 'attribution'>
      & { asset?: Maybe<(
        { __typename?: 'SanityImageAsset' }
        & Pick<SanityImageAsset, 'path'>
      )> }
    )> }
  )> }
);
...
export type GetPostsQuery = (
  ...
  & { allPost: Array<(
    { __typename?: 'Post' }
    & Pick<Post, '_id' | 'title' | 'publishedAt' | 'summary'>
    & { slug?: Maybe<(
      { __typename?: 'Slug' }
      & Pick<Slug, 'current'>
    )>, author?: Maybe<(
